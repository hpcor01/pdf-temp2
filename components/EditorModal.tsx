...
import { X, Wand2, Eraser, Check, Undo, RotateCcw, Redo } from 'lucide-react';
    ...
    >
      <div className="bg-white dark:bg-gray-900 w-[90vw] h-[90vh] rounded-lg flex flex-col border border-gray-300 dark:border-gray-700 shadow-2xl transition-colors duration-300" onClick={e => e.stopPropagation()}>
        ...
        <div className="flex-1 flex overflow-hidden">
          {/* Tools Sidebar */}
          <div className="w-64 bg-gray-50 dark:bg-gray-850 p-4 border-r border-gray-200 dark:border-gray-800 space-y-4">
          ...
          {/* Canvas Area */}
          <div className="flex-1 bg-gray-100 dark:bg-gray-950 flex items-center justify-center relative overflow-hidden select-none">
            {isProcessing && (
            ...
            <div 
              className="relative inline-block border border-gray-300 dark:border-gray-700 shadow-xl cursor-crosshair"
        ...
        {/* Footer */}
        <div className="h-16 border-t border-gray-200 dark:border-gray-800 flex items-center justify-end px-6 space-x-4 bg-white dark:bg-gray-900 transition-colors">
